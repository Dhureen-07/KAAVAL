    ...
    <div className="fixed top-5 left-1/2 -translate-x-1/2 z-50 pointer-events-none">
      <div className="pointer-events-auto glass-panel px-5 py-2.5 rounded-[28px] flex items-center gap-4">
        <Link href="/dashboard" className="flex items-center gap-2 hover:opacity-80 transition-opacity">
          ...
          <span className="font-bold tracking-[0.12em] uppercase text-[13px] text-[var(--color-text1)]">
            Kaaval
          </span>
        </Link>
        ...
        <div className="flex items-center gap-2">
          ...
          <span className="text-[11px] font-bold tracking-wider uppercase text-[var(--color-text2)]">
            {mod}
          </span>

    ...
    <div className="min-h-screen overflow-x-hidden bg-[var(--color-background)]" style={{ color: P.text1, fontFamily: "var(--font-sans)" }}>
        ...
        <div className="max-w-[1320px] mx-auto px-6 lg:px-10 flex items-center justify-between">
          <Link href="/" className="flex items-center gap-2.5 group">
            <div className="w-9 h-9 rounded-[20px] flex items-center justify-center bg-gradient-to-br from-[#3B82F6] to-[#60A5FA] group-hover:scale-110 group-hover:shadow-[0_0_20px_rgba(59,130,246,0.4)] transition-all">
              <Shield className="w-4 h-4 text-t1" />
            </div>
            <span className="text-t1 font-bold tracking-[0.14em] text-sm uppercase">Kaaval</span>
          </Link>
          <div className="hidden md:flex items-center gap-8 text-[13px] font-medium text-[#A1A1AA]">
            <button onClick={() => scrollTo("features")} className="hover:text-t1 transition-colors">Features</button>
            <button onClick={() => scrollTo("modules")} className="hover:text-t1 transition-colors">Modules</button>
            <Link href="/assistant" className="hover:text-t1 transition-colors">AI Assistant</Link>
          </div>
          <div className="flex items-center gap-3">
            <ThemeToggle />
            <Link href="/login" className="hidden sm:flex text-[13px] font-medium text-t2 hover:text-t1 transition-colors">Login</Link>
      ...
      <section className="relative min-h-screen flex flex-col items-center justify-center px-6 pt-28 pb-20 overflow-hidden">
        ...
        <div className={`relative z-10 text-center max-w-4xl mx-auto transition-all duration-1000 ease-[cubic-bezier(0.22,1,0.36,1)] ${mounted ? "opacity-100 translate-y-0 blur-0" : "opacity-0 translate-y-12 blur-[6px]"}`}>
          ...
          <h1 className="text-[clamp(2.8rem,7vw,5.5rem)] font-extrabold tracking-[-0.04em] leading-[1.05] text-t1 mb-6">
        ...
        <button onClick={() => scrollTo("stats")} className="absolute bottom-8 left-1/2 -translate-x-1/2 flex flex-col items-center gap-2 text-[#A1A1AA] hover:text-t1 transition-colors z-10">
          ...
          {[
            ...
            <R key={s.label} delay={i * 100}>
              <div className="flex items-center gap-4">
                ...
                <div>
                  <div className="text-2xl font-bold text-t1 tracking-tight">{s.value}</div>
        ...
        <div className="max-w-[1320px] mx-auto">
          <R>
            <div className="max-w-2xl mb-20">
              ...
              <h2 className="text-[clamp(1.8rem,4vw,3rem)] font-bold text-t1 tracking-tight leading-tight mb-5">
              ...
              <div className="rounded-[15px] p-6 lg:p-8" style={{ background: "#111113" }}>
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <h3 className="text-[15px] font-semibold text-t1">Statewide Analytics</h3>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
                  {[
                    ...
                    <div key={m.t} className="p-5 rounded-[20px] group hover:-translate-y-0.5 transition-all" style={{ background: "rgba(255,255,255,0.02)", border: `1px solid rgba(255,255,255,0.04)` }}>
                      ...
                      <div className="text-[1.6rem] font-bold text-t1 mb-1 tracking-tight">{m.v}</div>
                ...
                <div className="p-5 rounded-[20px]" style={{ background: "rgba(255,255,255,0.02)", border: `1px solid rgba(255,255,255,0.04)` }}>
                  <div className="flex items-center justify-between mb-6">
                    <span className="text-[13px] font-semibold text-t1">District Crime Distribution</span>
          ...
          <div id="modules">
            <R><div className="max-w-xl mb-14">
              ...
              <h2 className="text-[clamp(1.5rem,3.5vw,2.4rem)] font-bold text-t1 tracking-tight leading-tight">Purpose-Built Tools for Every Operation</h2>
            </div></R>
                ...
                <R key={m.title} delay={i * 80}>
                  <Link href={m.href} className="group block h-full">
                    <div className="glass-panel h-full p-7 rounded-[28px] transition-all duration-300 hover:-translate-y-1 flex flex-col relative overflow-hidden">
                      ...
                      <h3 className="relative text-[16px] font-semibold text-t1 mb-2 group-hover:text-[#3B82F6] transition-colors duration-300">{m.title}</h3>
      ...
      <section className="relative py-28 px-6 overflow-hidden" style={{ borderTop: `1px solid rgba(255,255,255,0.04)` }}>
        ...
        <R>
          <div className="relative z-10 max-w-2xl mx-auto text-center space-y-7">
            <h2 className="text-[clamp(1.8rem,4vw,3rem)] font-bold text-t1 tracking-tight leading-tight">
            ...
            <div className="flex flex-wrap items-center justify-center gap-4 pt-2">
              <Link href="/dashboard" className="group h-14 px-8 rounded-[28px] text-t1 text-[15px] font-bold flex items-center gap-2.5 transition-all hover:-translate-y-1 bg-gradient-to-r from-[#3B82F6] to-[#60A5FA] hover:shadow-[0_8px_40px_rgba(59,130,246,0.35)]">

  ...
  return (
    <div className="flex flex-col gap-6 max-w-4xl mx-auto w-full">
      <div className="mb-2">
        ...
        <p className="text-t2 mt-1">Manage your secure credentials and SCRB access levels.</p>
      </div>
          ...
          <CardContent className="space-y-6">
            <div className="flex items-center gap-4 border-b border-border/50 pb-4">
              ...
              <div>
                ...
                <p className="text-sm text-t2">Karnataka State Police - Cyber Division</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-4 border-b border-border/50 pb-4">
              ...
              <div>
                ...
                <p className="text-sm text-t2 font-mono">KA-POL-8492-SP</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-4 pb-2">
              ...
              <div>
                ...
                <p className="text-sm text-t2">ramesh.k@ksp.gov.in</p>
              </div>
            </div>
          </CardContent>
        </Card>

      ...
      <Reveal>
        <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-6 pb-6" style={{ borderBottom: `1px solid ${P.border}` }}>
          <div>
            ...
            <h1 className="text-3xl sm:text-4xl font-bold tracking-tight text-[color:var(--color-text1)] leading-tight">
              Command Center
            </h1>
        ...
        {cards.map((m, i) => (
          <Reveal key={m.title} delay={i * 100}>
            ...
            >
              ...
              <div className="relative text-[1.75rem] font-bold text-[color:var(--color-text1)] tracking-tight mb-1">{m.value}</div>
                  ...
                  <Reveal key={item.district} delay={i * 70}>
                    <div className="space-y-2">
                      <div className="flex items-center justify-between text-[12px]">
                        <span className="font-semibold text-[color:var(--color-text1)] flex items-center gap-2">
              ...
              <Reveal key={q.title} delay={i * 70}>
                <Link href={q.href} className="group block">
                  <div className="glass-panel p-4 rounded-[28px] text-center hover:-translate-y-1 transition-all duration-300 relative overflow-hidden">
                    ...
                    <span className="relative text-[12px] font-semibold text-[color:var(--color-text1)] block">{q.title}</span>
                  </div>
                </Link>
              </Reveal>
            ))}
                ...
                {incidents.map((inc, i) => (
                  <Reveal key={inc.id} delay={i * 70}>
                    ...
                    >
                      ...
                      <h4 className="text-[13px] font-semibold text-[color:var(--color-text1)] mb-2 leading-snug">{inc.title}</h4>

...
export default function VoiceToFIRPage() {
  ...
  const generateFIR = async (finalTranscript: string) => {
    ...
    try {
      const res = await fetch("https://kaaval-backend-50044365217.development.catalystappsail.in/api/intelligence/draft-fir", { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify({ transcript: finalTranscript }) });

  ...
  return (
    <div className="flex flex-col gap-6 max-w-4xl mx-auto w-full">
      <div className="mb-2">
        ...
        <p className="text-t2 mt-1">Configure your KAAVAL environment and intelligence preferences.</p>
      </div>
      ...
      <div className="grid grid-cols-1 gap-6">
          ...
          <CardContent className="space-y-4">
            <div className="flex items-center justify-between p-4 rounded-lg bg-card/50 border border-border/50">
              <div className="flex items-center gap-3">
                <Database className="w-5 h-5 text-t2" />
                <div>
                  <p className="font-medium">Live SCRB Database Link</p>
                  <p className="text-sm text-t2">Pull real-time FIR data across all districts.</p>
                </div>
              </div>
            ...
            <div className="flex items-center justify-between p-4 rounded-lg bg-card/50 border border-border/50">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-t2">Anonymize citizen names in predictive analytics.</p>
                </div>
              </div>
              <div className="w-12 h-6 bg-primary rounded-full relative cursor-pointer">
                <div className="w-4 h-4 bg-white rounded-full absolute right-1 top-1"></div>
        ...
        <Card className="glass-panel border-border/50">
          ...
          <CardContent className="space-y-4">
            <div className="flex items-center justify-between p-4 rounded-lg bg-card/50 border border-border/50">
              <div className="flex items-center gap-3">
                <Bell className="w-5 h-5 text-t2" />
                <div>
                  <p className="font-medium">High Priority Push Alerts</p>
                  <p className="text-sm text-t2">Receive immediate notifications for predicted hotspots.</p>
                </div>
              </div>

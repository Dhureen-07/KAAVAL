    ...
    <div className="flex flex-col h-full w-full">
      <div className="mb-6 flex justify-between items-end flex-wrap gap-4">
        <div>
          ...
          <p className="text-t2 mt-1">Geospatial analysis of crime density across Karnataka.</p>
        </div>
      </div>
      ...
      <Card className="glass-panel border-border/50 flex flex-col flex-1 relative overflow-hidden min-h-[500px]">
        ...
        <div className="absolute inset-0 flex items-center justify-center">
            ...
            <div className="z-10 flex flex-col items-center justify-center bg-black/50 backdrop-blur-md border border-white/10 p-8 rounded-[28px] mx-4 text-center">
                ...
                <h2 className="text-xl font-bold text-t1 mb-2">Map Engine Initializing...</h2>
